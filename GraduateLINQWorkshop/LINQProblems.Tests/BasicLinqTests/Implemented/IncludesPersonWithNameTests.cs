...
namespace LINQProblems.Tests.BasicLinqTests.Implemented
{
    ...
    public class IncludesPersonWithNameTests
    {
        ...
        public void IncludePersonWithNameAbby_EmptyList_ReturnsFalse()
        {
            ...
            //Act
            var includesPerson = LINQProblems.Implemented.BasicLinq.IncludesPersonWithName(people, "Abby");
        ...
        public void IncludePersonWithNameBob_AbbySmith_ReturnsTrue()
        {
            ...
            //Act
            var includesPerson = LINQProblems.Implemented.BasicLinq.IncludesPersonWithName(people, "Bob");
        ...
        public void IncludePersonWithNameFelicity_LotsOfPeople_ReturnsTrue()
        {
            ...
            //Act
            var includesPerson = LINQProblems.Implemented.BasicLinq.IncludesPersonWithName(people, "Felicity");
        ...
        public void IncludePersonWithNameEll_LotsOfPeople_ReturnsFalse()
        {
            ...
            //Act
            var includesPerson = LINQProblems.Implemented.BasicLinq.IncludesPersonWithName(people, "Ell");
